...
class EdgePerturber(Perturber):
    ...
    def forward(self) -> Tensor:       
        ...
        return self.model(self.graph_sample.x, self.graph_sample.edge_index, self.graph_sample.batch, F.sigmoid(self.P_x))
    ...
    def forward_prediction(self):
        ...
        return self.model(self.graph_sample.x, self.graph_sample.edge_index,  self.graph_sample.batch, P_x_discrete)
